...
점진적 대기(backoff) 후 재요청하여 네트워크 안정성을 확보합니다.
...
- 로컬과 CI(GitHub Actions) 환경의 타이머 동작 차이
- 재시도 로직 테스트의 복잡성

### 극복 방법

- fake timers 사용 최소화
- mock fetch 기반 테스트 설계
- 타임아웃 및 서버 오류를 테스트 코드에서 명확히 정의
- CI 환경에서도 항상 동일하게 동작하도록 테스트 구조 통합
